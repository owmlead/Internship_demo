...
# 必须做的预处理：先访问一次首页，获取  Cookie
print("正在获取 Cookie...")
session.get(url)
time.sleep(5)  # 给服务器一点时间下发 Cookie
...
# 获取电影信息数据
def get_movie_data(movie_url_list):
    movie_data = []
    for movie_url in movie_url_list:
        ...
        movie_screenwriter = document.xpath("//*[@id='original_header']/div[2]/section/div[3]/ol/li[2]/p[1]/a/text()")
        movie = {"name": movie_name, "date": movie_date, "type": movie_type, "time": movie_time, "grade": movie_grade,
